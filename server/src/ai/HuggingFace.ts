...
/**
 * This function calls the Inference API to get the Llama model for text completion.
 * 
 * This call is rate limited to 0.10$ worth of credits.
 */
export async function chatCompleteHuggingFace(message: string) {
